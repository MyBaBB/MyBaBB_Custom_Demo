          ...
          <nav
            ...
            <a
              ...
              <div
                ...
                <div
                  className="inline-block rounded-xl border-[1px]  border-varLIGHTBLUEFEATHER">
                  <div className="rounded-xl   border-[2px]  border-black">
                    <div
                      ...
                      <span
                        className="NavbarTitle1 Aclonica " >
                        About Us
                      </span>
                    </div>
                  </div>
                ...
                <div
                  ...
                  <div className="rounded-xl   border-[2px]  border-black">
                    <div
                      ...
                      <span
                        className="NavbarTitle2 Aclonica" >
                        Improve SEO
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl   border-[2px]  border-black">
                    <div
                      className="rounded-xl  border-[1px]  border-varLIGHTBLUEFEATHER
                                 p-2 hover:bg-black xxs:bg-gray-700">
                      <span
                        className="NavbarTitle3 Aclonica" >
                        Your Brand
                      </span>
                    </div>
                  </div>
            ...
            <a
              ...
              className="fixed -left-14 top-2 text-varLIGHTBLUEFEATHER hover:text-varLIGHTWING
