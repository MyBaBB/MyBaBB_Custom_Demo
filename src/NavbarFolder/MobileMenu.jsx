...
const MobileMenu = () => {
  return (
    <div className="hidden-square top-68   font-orbitron w-full origin-top animate-open-menu 
      ...
      <div
        ...
        <div   className="border-[12px] border-black border-b-gray-800 
          ...
          <div className="customInset  border-[1px] border-black   
                          border-l-transparent border-r-transparent  bg-yellow-950  "
            style={{
              boxShadow: "inset 0px 0px 20px rgba(0, 0, 0, 1)",
            }}>
            <h2 className="h2 transform-[translate(-50%, -50%)] relative 
            ...
            <span className="Kingthings whitespace-nowrap
      ...
      <nav        className=" mt-[3.75rem] flex min-h-screen flex-col items-center"
        aria-label="mobile">
        <p id="mobile-menu-2">
          <a href="#hero"
